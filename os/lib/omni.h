...
enum {
    ...
    OMNI_KEY_F12, OMNI_KEY_KPENTER = 96, OMNI_KEY_RCTRL = 97,
    OMNI_KEY_KPSLASH = 98, OMNI_KEY_RALT = 100, OMNI_KEY_HOME = 102,
    OMNI_KEY_UP = 103, OMNI_KEY_PAGEUP = 104, OMNI_KEY_LEFT = 105,
    OMNI_KEY_RIGHT = 106, OMNI_KEY_END = 107, OMNI_KEY_DOWN = 108,
    OMNI_KEY_PAGEDOWN = 109, OMNI_KEY_INSERT = 110,
    OMNI_KEY_DELETE = 111
};
