...
const struct omni_app_info omni_catalog[] = {
    ...
    { "taskmgr",  "Task Manager", "/usr/bin/omnios-taskmgr", "Utilities",
      "See what's running, CPU and memory, and end tasks.",    0, 0, 0x14b8a6, 'T' },
    { "clock",    "Clock",        "/usr/bin/omnios-clock",   "Utilities",
      "A big digital clock with today's date.",                0, 0, 0x6366f1, 'C' },
    { "calendar", "Calendar",     "/usr/bin/omnios-calendar", "Productivity",
      "Browse the months; today is always highlighted.",       0, 0, 0xef4444, 'D' },
    { "snake",    "Snake",        "/usr/bin/omnios-snake",   "Games",
      "The classic: eat, grow, and don't bite your tail.",     0, 0, 0x22c55e, 'S' },
    { "mines",    "Minesweeper",  "/usr/bin/omnios-mines",   "Games",
      "Clear the field without setting off a mine.",           0, 0, 0x64748b, '*' },
    { "2048",     "2048",         "/usr/bin/omnios-2048",    "Games",
      "Slide the tiles, merge the numbers, reach 2048.",       0, 0, 0xedc22e, '2' },
    { "tictactoe", "Tic-Tac-Toe", "/usr/bin/omnios-tictactoe", "Games",
      "Three in a row, against the computer or a friend.",     0, 0, 0xec4899, 'X' },
